...
int main(int argc,char**argv){try{
 ...
 require(bool(in)&&N>0&&N<100000&&steps>0&&steps<=1000000,"invalid dimensions");  /* steps limit raised 100000 -> 1000000 for the m=184320 net; sanity bound only, no correctness role. */require(G>0&&li>0&&bi>0&&wd>0,"invalid scale");
 ...
 /* D4 assert removed for third-party replay of an asymmetric measure; the sweep below uses the atoms directly for every direction and does not mirror the measure. */
